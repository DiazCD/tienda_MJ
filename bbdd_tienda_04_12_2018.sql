...
INSERT INTO `articulo` (`id`, `id_vendedor_art`, `id_categoria_art`, `id_subcategoria_art`, `nombre_art`, `descripcion_art`, `importe_art`, `fecha_alta_art`, `cantidad_max_art`, `imagen_art`) VALUES
	(1, 3, 1, 1, 'Abeja Reina', 'Mu buena', 10, '2018-11-27 00:00:00', 5, 'images/products/AbejaReina.jpg'),
	(2, 3, 1, 1, 'Marijuana', 'Mu güena tambien', 10, '2018-11-23 01:05:48', 3, 'images/products/Marijuana.jpg');
...
INSERT INTO `comentario` (`id`, `id_articulo_com`, `id_usuario_com`, `descripcion_com`, `valoracion_com`, `fecha_alta_com`) VALUES
